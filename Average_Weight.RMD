...
We can be 95% confident the average weight is between 54 and 65 Kilograms (provided by the calculated CI). 
The p-value is well above the significance level of 0.05, therefore we fail to reject the null hypothesis
in favour of the alternative; indicating the true population Mean is approximately 59.